...
The canonical deep example is `skills/04-aoota-classification/references/proximal-femur-31.md`. Most other AO/OTA segments are present as stubs. Pick a region you know well and expand its reference file using the proximal-femur file as a template.
...
`skills/05-region-classifications/references/` is where complementary systems live. The Garden + Pauwels combination for proximal femur is the canonical example. Wanted:
